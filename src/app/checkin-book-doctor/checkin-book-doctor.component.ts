...
@Component({
  selector: 'app-checkin-book-doctor',
  templateUrl: './checkin-book-doctor.component.html',
  styleUrls: ['./checkin-book-doctor.component.css']
})
export class CheckinBookDoctorComponent implements OnInit {
...
onNextSelect(){
  ...
  this.route.navigate(['/chekin-book-date'])
