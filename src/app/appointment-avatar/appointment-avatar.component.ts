...
@Component({
  selector: 'app-appointment-avatar',
  templateUrl: './appointment-avatar.component.html',
  styleUrls: ['./appointment-avatar.component.css']
})
export class AppointmentAvatarComponent implements OnInit {
  ...
  // "Head", "Head-2", "neck", "left_shoulder", "right_shoulder",'Scalp','mouth'
