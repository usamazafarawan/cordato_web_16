...
@Component({
  selector: 'app-appointment-book-doctor-details',
  templateUrl: './appointment-book-doctor-details.component.html',
  styleUrls: ['./appointment-book-doctor-details.component.css']
})
export class AppointmentBookDoctorDetailsComponent implements OnInit {
